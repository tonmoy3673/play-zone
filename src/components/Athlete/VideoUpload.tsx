    ...
    return (
      <div className="w-full mx-auto">
        <div
          ...
          onDrop={handleDrop}
          className="border border-dashed border-[#276AEE] rounded-lg p-12 text-center cursor-pointer transition-all"
        >
