      ...
      <label className="inline-flex items-center cursor-pointer group">
        <div className="relative">
          <input
            ...
            type="checkbox"
            className={cn(
              "size-5 p-0.5 flex items-center justify-center rounded border-2 border-dark/40 appearance-none peer",
              "transition-all duration-300 ease-in-out cursor-pointer",
              "hover:border-blue-400 hover:scale-105",
              "focus:outline-none focus:scale-105",
              "checked:border-transparent checked:bg-primary-gradient checked:scale-105",
              "active:scale-95",
              className
            )}
            onChange={onChange}
