...
import AnnouncementMenu, {
  AnnouncementStep,
} from "../_components/AnnouncementMenu";
          ...
          <div className="flex gap-4 justify-between mt-12">
            {currentStep > 1 && (
              <>
                <button
                  ...
                  type="button"
                  className="px-8 py-3 rounded-full bg-[#FFFFFF4D] text-black font-semibold hover:bg-blue-100 transition flex gap-2 items-center"
                >
            ...
            <div className="flex gap-4 justify-end items-end">
              ...
              {currentStep < steps.length && (
                <button
                  onClick={() =>
                    handleStepClick(Math.min(currentStep + 1, steps.length))
                  }
                  type="button"
