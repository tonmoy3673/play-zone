          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-5">
              ...
              <button
                ...
                className={`flex-1 bg-[rgba(186,209,255,0.1)] rounded-[16px] p-5 flex flex-col items-center gap-5 transition-all ${eventType === "message-task"
              ...
              <button
                ...
                className={`flex-1 bg-[rgba(186,209,255,0.1)] rounded-[16px] p-5 flex flex-col items-center gap-5 transition-all ${eventType === "create-task"
                    ? "border-2 border-[#5c8ff7]"
                    : "border-2 border-transparent"
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 bg-[rgba(186,209,255,0.1)] rounded-[16px] p-5 flex flex-col items-center gap-5 transition-all ${eventType === "personal-task"
                    ? "border-2 border-[#5c8ff7]"
                    : "border-2 border-transparent"
                  }`}
              >
