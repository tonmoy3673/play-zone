...
const Previous = () => {
  ...
  const filters = [
    ...
    { label: "Q2 2025", count: 0 },
    { label: "Q1 2025", count: 0 },
    { label: "2024", count: 0 },
  ];
  ...
  const [includeEngagementEnabled, setIncludeEngagementEnabled] = useState(true);
  const [archiveCommentsEnabled, setArchiveCommentsEnabled] = useState(true);
            ...
            <div className="bg-[#FFFFFF99] p-5 rounded-2xl space-y-6">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex justify-between mb-6">
                  ...
                  <Switch
                    value={includeEngagementEnabled}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setIncludeEngagementEnabled(e.target.checked)
                    }
                  />
                </div>
                <div className="flex justify-between mb-6">
                  ...
                  <Switch
                    value={archiveCommentsEnabled}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setArchiveCommentsEnabled(e.target.checked)
                    }
                  />
                </div>
