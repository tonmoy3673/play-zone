...
export default function TasksCoachPage() {
			 ...
			 >
				<div className="flex items-center gap-4 flex-1">
				  <div>
					 ...
					 <div className="flex items-center gap-2 mt-3 text-[#141b3499]">
						<div
						  style={{
							 borderRadius: "4px",
				...
				<div className="flex items-center gap-4">
				  <div className="flex items-center gap-2 text-[#141b3499] min-w-20">
					 {task.status === "pending" && (
						<>
