      ...
      <div className="w-full  max-w-screen-xl mx-auto">
        ...
        <div className="mb-5 ">
          <div className="grid grid-cols-3 gap-6">
            <div>
              <label className="mb-2  flex items-center gap-1 text-sm font-medium text-dark-100">
                Location
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="13"
        ...
        <div className="mb-5 ">
          ...
          <div className=" border bg-[#ffffff80] backdrop-blur-3xl border-white rounded-lg p-5 flex items-center justify-between">
        ...
        <div className="mb-5">
          ...
          <div className="space-y-3">
            {achievements.map((achievement) => (
              <div
                key={achievement.id}
                className="flex items-center justify-between backdrop-blur-3xl border border-white bg-[#ffffff80] p-4 py-5 rounded-lg"
              >
        ...
        <div className="mb-5">
          ...
          {/* Toggle Options */}
          <div className="space-y-2 bg-[#ffffff99] backdrop-blur-3xl border border-white rounded-xl p-5 mb-8">
