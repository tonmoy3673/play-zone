...
export default function CurrentTasks() {
  ...
  return (
    <section className="overflow-clip relative rounded-3xl p-5 mb-8 border border-white bg-[#E7F2F5]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mt-6">
        ...
        <nav className="flex items-center gap-1">
          ...
          <button className="bg-[rgba(255,255,255,0.6)] rounded-lg size-8 flex items-center justify-center hover:bg-white transition">
            <span className="text-[10px] font-medium text-dark leading-[1.4] rotate-90">
              <Icon
                name="three_dots_vertical"
                height={20}
                width={20}
