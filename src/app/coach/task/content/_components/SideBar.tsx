  ...
  const menuItems = [
    {
      ...
      label: "All Tasks",
      isActive: pathname === "/coach/task/content",
      badge: null,
    ...
    },
    {
      ...
      label: "Active Tasks",
      isActive: pathname.startsWith("/coach/task/content/active-tasks"),
      badge: "15",
      href: "/coach/task/content/active-tasks",
    },
    {
      id: 3,
      iconName: "user_love_01" as const,
      label: "Task Overview",
      isActive: pathname.startsWith("/coach/task/content/task-overview"),
      badge: null,
    ...
    },
    {
      ...
      isActive: pathname.startsWith("/coach/task/content/awaiting-review"),
      badge: "15",
    ...
    },
    {
      ...
      isActive: pathname.startsWith("/coach/task/content/completed-tasks"),
      badge: null,
      href: "/coach/task/content/completed-tasks",
    },
    {
      id: 6,
      iconName: "user_group" as const,
      label: "Staff Review Log",
      isActive: pathname.startsWith("/coach/task/content/staff-review-log"),
      badge: null,
      href: "/coach/task/content/staff-review-log",
    },
    {
      id: 7,
      iconName: "library" as const,
      label: "Content Library",
      isActive: pathname.startsWith("/coach/task/content/content-library"),
      badge: null,
      href: "/coach/task/content/content-library",
    },
  ];

  return (
    <aside className="bg-white/60 box-border hidden lg:flex flex-col gap-4 items-start overflow-clip px-4 py-6 rounded-[24px] shrink-0 self-start sticky top-0 w-[230px]">
