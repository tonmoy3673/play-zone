...
const getBadgeChip = (badge: string) => {
  switch (badge) {
    case "Top Effort":
      return (
        <div className="bg-gradient-to-b from-[rgba(255,0,51,0.12)] to-[rgba(255,0,51,0.15)] border border-[rgba(255,0,51,0.1)] rounded-full px-2 py-1 font-medium">
          <p className="text-[#ff0033] text-[10px]">{badge}</p>
        </div>
      );
    case "Perfect Form":
      return (
        <div className="bg-gradient-to-b from-[rgba(69,127,243,0.12)] to-[rgba(69,127,243,0.15)] border border-[rgba(69,127,243,0.1)] rounded-full px-2 py-1 font-medium">
...
const TopPerformers = () => {
  return (
    <div className="bg-white/30 rounded-3xl p-5 border border-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {performers.map((performer, index) => (
          ...
          >
            ...
            <h3 className="font-medium text-center mb-1">{performer.name}</h3>
