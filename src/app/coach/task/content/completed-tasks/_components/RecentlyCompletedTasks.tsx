    ...
    <div className="bg-rgba(255, 255, 255, 0.30) backdrop-blur-3xl rounded-3xl p-5 border border-white/80 my-5">
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center gap-2">
          <button className="bg-white/60 rounded-xl flex items-center justify-center transition-colors size-12">
            <Icon name="filter_horizontal" height={16} width={18} />
          </button>
          <button className="bg-white/60 hover:bg-white/80 rounded-xl px-4 h-12 flex items-center gap-x-4 transition-colors">
        ...
        <table className="w-full">
          ...
          <tbody>
            {completedTasks.map((task) => (
              <tr
                key={task.id}
                className="border-b border-gray-100 last:border-b-0 hover:bg-white/20 transition-colors"
              >
                {/* Task Name */}
                <td className="py-4 px-6">
                  <p className="text-[10px] font-medium text-dark-100">
                    {task.taskName}
                  </p>
                </td>
                ...
                <td className="py-4 px-6">
                  <span
                    className={`inline-flex items-center justify-center px-3 py-2.5 rounded-full text-xs font-medium border ${task.typeColor}`}
                  >
                    {task.type}
                  </span>
                </td>
                ...
                <td className="py-4 px-6">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-[10px] font-normal text-paragraph-dark">
                      {task.completionTime}
                    </p>
                  </div>
                </td>
