...
const badgeStyles = {
  danger:
    "bg-linear-to-b from-[rgba(255,0,51,0.05)] to-[rgba(255,0,51,0.12)] border border-[rgba(255,0,51,0.1)] text-[#ff0033]",
  purple:
    "bg-linear-to-b from-[rgba(120,78,248,0.05)] to-[rgba(120,78,248,0.12)] border border-[rgba(120,78,248,0.1)] text-[#784ef8]",
  info: "bg-linear-to-b from-[rgba(69,127,243,0.05)] to-[rgba(69,127,243,0.12)] border border-[rgba(69,127,243,0.1)] text-[#437EF7]",
  success:
    "bg-linear-to-b from-[rgba(0,226,128,0.05)] to-[rgba(0,226,128,0.12)] border border-[rgba(0,226,128,0.1)] text-[#027a48]",
};
...
function SubmissionCard({
  ...
  const handleReviewNow = () => {
    router.push("/coach/task/content/awaiting-review/review");
  };
    ...
    <div className="bg-[rgba(255,255,255,0.6)] overflow-clip relative rounded-[16px] shrink-0 p-4 flex flex-col">
      ...
      <div className="flex flex-col gap-4 items-start w-full">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div
            className={`bg-linear-to-b border rounded-[61px] flex gap-1 h-6 items-center justify-center px-2 py-2.5 shrink-0 ${
        ...
        <div className="flex flex-col gap-5 w-full">
          ...
          <div className="flex gap-2 items-center justify-center w-full">
            <button
              ...
              className="bg-linear-to-b from-[rgba(69,127,243,0.05)] to-[rgba(69,127,243,0.12)] border border-[rgba(69,127,243,0.1)] rounded-[61px] flex gap-3 items-center justify-center px-4 py-3 w-[122px]"
            >
...
export default function Submission() {
  return (
    <div className="bg-[rgba(255,255,255,0.3)] overflow-clip relative rounded-[24px] w-full px-5 py-5 border border-white">
