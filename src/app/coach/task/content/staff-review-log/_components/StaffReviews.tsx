    ...
    <div className="bg-rgba(255, 255, 255, 0.30) backdrop-blur-3xl rounded-3xl p-5 border border-white my-5">
      ...
      <div className="flex justify-between items-center mb-5">
        <div className="flex items-center gap-2">
          <button className="bg-white hover:bg-white/80 rounded-xl h-12 p-5 flex items-center gap-x-4 transition-colors">
        ...
        <div className="flex items-center gap-2">
          <button className="bg-white hover:bg-white/80 rounded-2xl size-12 flex justify-center items-center transition-colors">
            <Icon name="filter_horizontal" height={18} width={18} />
          </button>
          <button className="bg-white hover:bg-white/80 rounded-2xl size-12 flex justify-center items-center transition-colors">
            <Icon name="download_04" height={18} width={18} />
          </button>
        </div>
      </div>
          ...
          <tbody>
            {staffReviews.map((review) => (
              ...
              >
                ...
                <td className="py-6 px-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <p className="text-xs font-[600] text-dark">
                        {review.coach.name}
                      </p>
                ...
                {/* Task */}
                <td className="py-6 px-4">
                  <p className="text-xs font-medium text-dark">{review.task}</p>
                </td>
