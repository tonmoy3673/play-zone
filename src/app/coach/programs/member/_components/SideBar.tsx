...
function ProgramCard() {
  ...
  return (
    <div className={cn(
      "bg-[rgba(255,255,255,0.66)] overflow-hidden relative rounded-[19px] shrink-0 w-[214px] transition-all duration-300",
      isCollapsed ? "h-[68px]" : "h-[184px]"
    )}>
      ...
      {/* Full white overlay when collapsed */}
      {isCollapsed && (
        <div className="absolute inset-0 bg-white rounded-[19px]" />
      )}
      <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[8px] top-[8px] w-[198px] z-10">
        <div className="bg-[#1a5bd9] box-border content-stretch flex gap-[2px] items-center pl-[4px] pr-[8px] py-[4px] relative rounded-[12px] shrink-0 w-full">
          <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
            ...
            <div className="">
              <button 
                className="bg-[rgba(255,255,255,0.08)] p-1 rounded-full"
...
export default function CustomSideBar() {
  ...
  return (
    <aside className="relative z-10 hidden md:flex h-full flex-col items-start overflow-x-hidden bg-[rgba(255,255,255,0.05)] text-sm font-normal transition-all duration-300 ease-in-out" >
      <div className="bg-[rgba(255,255,255,0.05)] box-border flex flex-col gap-[10px] items-start overflow-x-hidden px-[16px] py-[24px] rounded-[16px] h-full w-[246px]" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }} >
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
          {/* Back Button */}
          <Link
          ...
          {/* Navigation Items */}
          <Link
            href="/coach/programs/details/23"
            className={cn(
              "content-stretch flex gap-[8px] items-center relative shrink-0 w-full",
              isActive("/coach/programs/details/23") && "opacity-100"
            )}
          >
            <div className="box-border content-stretch flex gap-[6px] items-center justify-center p-[4px] relative rounded-[6px] shrink-0 size-[40px]">
              <Icon name="dashboard_square_01" height={20} width={20}
                className={
                  isActive("/coach/programs/details/23")
                    ? "text-black"
                    : "text-dark"
                } />
            </div>
          ...
          >
            <div className="box-border content-stretch flex gap-[6px] items-center justify-center p-[4px] relative rounded-[6px] shrink-0 size-[40px]">
              <Icon name="marketing" height={20} width={20}
                className={
                  isActive("/coach/programs/announcement")
                    ? "text-white"
                    : "text-dark"
                } />
            </div>
          ...
          <Link
            href="/coach/programs/member"
            className={cn(
              "content-stretch flex gap-[8px] items-center relative shrink-0 w-full",
              isActive("/coach/programs/member") && "opacity-100 "
            )}
          >
            <div className="border-[#68b0ea] border-b-0 border-l-0 border-r-0 border-solid border-t box-border content-stretch flex gap-[10px] items-center p-[10px] relative rounded-[12px] shrink-0 bg-primary-gradient">
              <Icon
                ...
                width={20}
                className={
                  isActive("/coach/programs/member")
            ...
            <div className="bg-[rgba(255,255,255,0.2)] overflow-clip relative rounded-[15px] shrink-0 size-[20px]">
              ...
              >
                <Icon
                  ...
                  width={10}
                  className={cn(
                    "text-dark-700 [&_path]:stroke-black! transition-transform duration-200",
                    isOthersCollapsed ? "rotate-180" : ""
                  )}
                />
              </button>
            </div>
          ...
          {!isOthersCollapsed && (
            <>
              <Link
                href="/coach/programs/analytics"
                className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full"
              >
                <div className="box-border content-stretch flex gap-[10px] items-center p-[10px] relative shrink-0">
                  <Icon name="analytics_up" height={20} width={20}
                    className={
                      isActive("/coach/programs/analytics")
                        ? "text-white"
                        : "text-dark"
                    }
                  />
              ...
              <Link
                href="/coach/programs/specific-financial-analytics"
                className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full"
              >
                <div className="box-border content-stretch flex gap-[10px] items-center p-[10px] relative shrink-0">
                  <Icon name="money_bag_02" height={20} width={20}
                    className={
                      isActive("/coach/programs/specific-financial-analytics")
                        ? "text-white"
                        : "text-dark"
                    }
                  />
              ...
              >
                <div className="box-border content-stretch flex gap-[10px] items-center p-[10px] relative shrink-0">
                  <Icon name="ranking" height={20} width={20}
                    className={
                      isActive("/coach/programs/leaderboard")
                        ? "text-white"
                        : "text-dark"
                    }
                  />
            ...
            <div className="bg-[rgba(255,255,255,0.2)] overflow-clip relative rounded-[15px] shrink-0 size-[20px]">
              ...
              >
                <Icon
                  ...
                  className={cn(
                    "text-dark-700 [&_path]:stroke-black! transition-transform duration-200",
                    isAdminCollapsed ? "rotate-0" : "rotate-180"
                  )}
                />
              </button>
            </div>
          ...
          {!isAdminCollapsed && (
            <>
              <Link
                href="/coach/programs/support"
                className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full"
              >
                <div className="box-border content-stretch flex gap-[10px] items-center p-[10px] relative shrink-0">
                  <Icon name="customer_support" height={20} width={20}
                    className={
                      isActive("/coach/programs/support")
                        ? "text-white"
                        : "text-dark"
                    }
                  />
              ...
              <Link
                href="/coach/programs/settings"
                className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full"
              >
                <div className="box-border content-stretch flex gap-[10px] items-center p-[10px] relative shrink-0">
                  <Icon name="settings_01" height={20} width={20}
                    className={
                      isActive("/coach/programs/settings")
                        ? "text-white"
                        : "text-dark"
                    }
                  />
