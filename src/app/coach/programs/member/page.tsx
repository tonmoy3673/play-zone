...
function MemberCard({
  ...
  return (
    <div
      className={cn(
        "bg-white/60 border border-white h-[192px] overflow-hidden relative rounded-[16px] w-full",
    ...
    >
      ...
      <div className="relative flex items-center justify-between px-5 pt-5 z-10">
        ...
        <div className="flex gap-1 ml-auto">
          <button
            className="bg-white rounded-full size-10 flex items-center justify-center hover:bg-gray-50 transition-colors"
      ...
      <div className="relative flex-1 px-5 pb-5 my-5 flex flex-col justify-between z-10">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex flex-col gap-1.5 flex-1 min-w-0">
            <Link href={`/coach/programs/member/profile`}>
...
export default function MemberPage() {
  ...
  return (
    <div className="bg-white/30 backdrop-blur-3xl border border-white overflow-clip relative rounded-[30px] w-full min-h-screen p-8">
      ...
      <div className="relative z-10 bg-white/30 backdrop-blur-3xl border border-white box-border flex gap-[10px] items-center p-2.5 rounded-[16px] mb-6 w-full">
