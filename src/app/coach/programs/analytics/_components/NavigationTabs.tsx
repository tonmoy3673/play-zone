    ...
    <div className="flex gap-3 mb-4 overflow-x-auto p-2.5 bg-white/30 rounded-2xl border-white border">
      {[
        ...
        },
        {
          ...
          href: "/coach/programs/analytics/athlete",
        },
        {
          icon: "task_edit" as IconName,
          label: "Task Analytics",
          href: "/coach/programs/analytics/task",
        },
        {
          icon: "users" as IconName,
          label: "Engagement",
          href: "/coach/programs/analytics/engagement",
        },
        {
          icon: "video" as IconName,
          label: "Live Sessions",
          href: "/coach/programs/analytics/live-sessions",
        },
        {
          icon: "analytics_up" as IconName,
          label: "Progress",
          href: "/coach/programs/analytics/progress",
        },
        {
          icon: "medal" as IconName,
          label: "Leaderboard",
          href: "/coach/programs/analytics/leaderboard",
        },
      ].map((tab, idx) => (
