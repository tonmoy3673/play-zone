...
const deviceData = [
  { name: "Athlete", value: 42, percentage: 55 },
  { name: "Staff", value: 25, percentage: 28 },
  { name: "You", value: 12, percentage: 11 },
];
    ...
    <Card className="bg-white/60">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <SectionHeader title="Program Members" className="mb-13" />
          ...
          <div className="space-y-6 text-sm">
            {deviceData.map((item, idx) => (
              <div key={idx} className="flex flex-col">
                ...
                <span className="font-semibold text-dark text-2xl py-2">
