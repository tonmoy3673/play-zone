...
export default function ProgramShowcase({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Container */}
      <div className="relative bg-white bg-[url('/overview/modalBG.png')] w-[90vw] max-w-[800px] max-h-[85vh] backdrop-blur-lg rounded-[24px] border border-white/30 shadow-2xl overflow-hidden">
        <div
          style={{
            background:
              "linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.65) 35%, rgba(255,255,255,0.9) 60%, #FFFFFF 85%)",
            boxShadow: "0 -40px 60px rgba(255,255,255,0.85)",
          }}
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(180deg, rgba(255,255,255,0) 100%, rgba(255,255,255,0.9) 40%, #FFFFFF 90%, #FFFFFF 100%, #FFFFFF 100%)",
          pointerEvents: "none",
        }}
      ...
      >
        ...
        <div className="h-[14px] w-full rounded-full bg-[#e6ecff]">
          <div className="h-full w-1/2 rounded-full bg-[#bcd0ff]/30" />
        </div>
