...
export const beginnerFriendlyPrograms: ProgramProp[] = [
  {
...
const BeginnerFriendlyProgram = () => {
  return (
    <div>
      <SectionHeader title="Beginner Friendly" href="/" className="mb-5" />

      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {beginnerFriendlyPrograms.map((program, index) => (
...
export default BeginnerFriendlyProgram;
