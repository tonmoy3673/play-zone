    ...
    <div className="w-full mt-5 bg-[#ffffff4d] backdrop-blur-3xl border border-white p-5 rounded-3xl">
      <div>
        ...
        <div className="flex items-center justify-between mb-[22px]">
          <h1 className="text-lg font-medium text-black">Current Programs</h1>
          <button className="bg-[linear-gradient(177deg,#5C8FF7_10.06%,#276AEE_62.94%)] bg-clip-text text-transparent font-medium text-sm transition-colors">
            View All
          </button>
        </div>
        ...
        <div
          ...
          className="flex items-start gap-4 overflow-x-auto whitespace-nowrap"
        >
...
function ProgramCard({ program }: ProgramCardProps) {
  return (
    ...
    >
      <div className="absolute right-4 top-4 flex items-center justify-center size-10 rounded-full bg-white/20 z-[1] backdrop-blur-xs after:absolute after:inset-0 after:border-l after:border-r after:border-white/50 after:rotate-45 after:rounded-full after:z-[-1]">
