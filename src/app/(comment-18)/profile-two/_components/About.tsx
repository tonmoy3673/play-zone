    ...
    <div className="p-5 rounded-2xl border backdrop-blur-3xl bg-[#ffffff4d] border-white">
      ...
      <p className="text-dark/70 text-sm mb-5">
        ...
        <span
          ...
          className="text-sm inline-block font-medium cursor-pointer bg-[linear-gradient(177deg,#5C8FF7_10.06%,#276AEE_62.94%)] bg-clip-text text-transparent"
        >
      ...
      <div className="mt-4 flex gap-2 flex-wrap">
        <Button className="flex items-center flex-nowrap rounded-full gap-2 h-8 px-3 py-1.5 text-[10px] font-medium bg-[linear-gradient(180deg,rgba(69,127,243,0.15)_0%,rgba(69,127,243,0.30)_100%)] border border-[#457ff31a]">
          ...
          <span className="bg-[linear-gradient(177deg,#5C8FF7_10.06%,#276AEE_62.94%)] bg-clip-text text-transparent text-[10px] font-medium">
            Casual Rider
          </span>
        </Button>
        <Button className="flex items-center flex-nowrap rounded-full gap-2 h-8 px-3 py-1.5 text-[10px] font-medium bg-[linear-gradient(180deg,rgba(235,158,15,0.15)_0%,rgba(235,158,15,0.30)_100%)] border border-[#EB9E0F1A]">
          <Icon name="users_yellow" height={20} width={20} />
        ...
        <Button className="flex items-center flex-nowrap rounded-full gap-2 h-8 px-3 py-1.5 text-[10px] font-medium bg-[linear-gradient(177deg,#5C8FF7_10.06%,#276AEE_62.94%)] border border-[#457FF31A]">
          <Icon name="plus_white" height={20} width={20} />
