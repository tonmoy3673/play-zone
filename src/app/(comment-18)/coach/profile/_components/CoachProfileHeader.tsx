          ...
          <div>
            <div className="relative">
              ...
              <Link href={"/athlete/profile/settings"}>
                <AnimatedButton className="flex items-center gap-1.5 px-3 -translate-y-4 rounded-full border border-[#68B0EA] text-[11px] text-white bg-[linear-gradient(177deg,#5C8FF7_10.06%,#276AEE_62.94%)]">
