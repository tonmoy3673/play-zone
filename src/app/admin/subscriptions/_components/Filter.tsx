...
const Filter = () => {
  return (
    <div className="flex flex-wrap gap-2 mb-5 justify-between">
      ...
      <div className="w-full max-w-[287px] flex-1 h-11 px-4 py-3 rounded-full bg-white/60 border-white border flex items-center gap-3">
        <Icon name="search" height={20} width={20} className="text-[#595F70]" />
        <input
          type="text"
          placeholder="Search by users or emails..."
