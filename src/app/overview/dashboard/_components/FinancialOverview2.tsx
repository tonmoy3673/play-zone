            ...
            >
              <div className="relative w-14 h-14">
                {/* <div className="absolute inset-[16px] flex items-center justify-center bg-transparent">
                  <img src={"/overview/dolar.svg"} className="w-6 h-6" />
                </div> */}
              ...
              <div className="flex flex-col text-sm text-[#141b34b3]">
                ...
                <span className="text-[#141b34] text-2xl font-bold font-['DM Sans',sans-serif] mt-2">
                  {amount}
                </span>
              </div>
              <div className="ml-auto flex items-center gap-1 text-xs font-medium">
                ...
                <img
                  src={
                    positive ? "/overview/iconUp.svg" : "/overview/iconDown.svg"
                  }
              ...
              <div className="flex ">
                {["Week", "Month", "Yearly"].map((item) => (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm ml-3 font-medium transition-all duration-200 ${
                      period === item
